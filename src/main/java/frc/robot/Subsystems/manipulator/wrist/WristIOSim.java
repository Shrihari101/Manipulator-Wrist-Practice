        ...
        new SingleJointedArmSim(
            LinearSystemId.createSingleJointedArmSystem(
                ...
                SingleJointedArmSim.estimateMOI(
                    ManipulatorWristConstants.kLengthMeters, ManipulatorWristConstants.kMassKg),
                ManipulatorWristConstants.kGearing),
            ManipulatorWristConstants.kWristSimGearbox,
            ManipulatorWristConstants.kGearing,
            ManipulatorWristConstants.kLengthMeters,
            ManipulatorWristConstants.kMinAngle.getRadians(),
            ManipulatorWristConstants.kMaxAngle.getRadians(),
            false,
            ManipulatorWristConstants.kStartingAngle.getRadians());
