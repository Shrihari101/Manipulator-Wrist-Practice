...
public class ElevatorIOKraken implements ElevatorIO {
  ...
  public ElevatorIOKraken(int leadingPort, int followingPort) {
    ...
    var currentConfigs =
        new CurrentLimitsConfigs()
            ...
            .withSupplyCurrentLimit(ElevatorConstants.kElevatorDefaultSupplyLimit)
            .withStatorCurrentLimitEnable(true)
            .withStatorCurrentLimit(ElevatorConstants.kElevatorDefaultStatorLimit);
    ...
    m_config =
        new TalonFXConfiguration()
            ...
            .withMotorOutput(motorOutput); // kents configs
  ...
  public void updateInputs(ElevatorInputs inputs) {
    ...
    inputs.leadingTemperature = m_leadingTemp.getValue().in(Celsius);
    inputs.followingTemperature = m_followingTemp.getValue().in(Celsius);
    inputs.positionControl = m_isPositionControl;
  }

  @Override
  public void setDesiredHeight(double inchesHeight) {
    m_desiredHeight = inchesHeight;
    m_isPositionControl = true;
    inchesHeight =
        MathUtil.clamp(inchesHeight, ElevatorConstants.kMinHeight, ElevatorConstants.kMaxHeight);
  }
  ...
  public void setCurrentLimits(double currentLimits) {
    m_config.CurrentLimits.withSupplyCurrentLimit(currentLimits);
